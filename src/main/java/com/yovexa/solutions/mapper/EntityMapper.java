...
public class EntityMapper {
    ...
    public AboutResponse toAboutResponse(AboutSection about) {
        ...
        return AboutResponse.builder()
                ...
                .image(about.getImage() != null && !about.getImage().isBlank() ? about.getImage() : "/about-visual.jpg")
                .imageAlt(about.getImageAlt() != null && !about.getImageAlt().isBlank() ? about.getImageAlt() : "Enterprise Cloud Architecture & Digital Product Engineering")
                .imageCategory(about.getImageCategory() != null && !about.getImageCategory().isBlank() ? about.getImageCategory() : "Enterprise Technology")
                .imageTitle(about.getImageTitle() != null && !about.getImageTitle().isBlank() ? about.getImageTitle() : "Cloud Architecture & Digital Solutions")
                .imageBadge(about.getImageBadge() != null && !about.getImageBadge().isBlank() ? about.getImageBadge() : "Production-Ready")
